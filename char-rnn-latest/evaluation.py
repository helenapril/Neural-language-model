...
flags.DEFINE_string('train_dir',   'check_rnn_double',     'training directory')
...
# optimization
flags.DEFINE_integer('batch_size',        10,  'numbcer of sequences to train on in parallel')
